...
//import static com.ranchosoftware.speedymovinginventory.R.drawable.camera;
...
public class CameraSource {
  ...
  public CameraSource (Context context) throws IOException {
    synchronized (mCameraLock) {
      if (mCamera != null) {
  ...
  private Camera createCamera() throws IOException{
    ...
    try {
      ...
      if (Build.VERSION.SDK_INT == 22){
        ...
        throw new IOException("The phone is using Version 5.1 (Api Level 22) of Android. This version has a known camera issue." +
                " Powering your phone off and back on may resolve the problem.");

      } else {

        throw new IOException("Unexpected error: Camera is not accessible. ");
