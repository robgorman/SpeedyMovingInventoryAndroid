...
import com.speedymovinginventory.speedyinventory.BuildConfig;
...
public class Job extends Model {
  ...
  // maps for pickup and delivery site pics
  private Map<String, String> pickupSiteImages;
  private Map<String, String> deliverySiteImages;

  // no-args constructor require for firebase
  public Job(){

    pickupSiteImages = new TreeMap<>();
    deliverySiteImages = new TreeMap<>();
  }
  public Job(
          String jobNumber,
          String companyKey,
    ...
    this.pickupSiteImages = new TreeMap<>();
    this.deliverySiteImages = new TreeMap<>();
  }
  ...
  public Map<String, String> getPickupSiteImages() {
    return pickupSiteImages;
  }

  public void setPickupSiteImages(Map<String, String> pickupSiteImages) {
    this.pickupSiteImages = pickupSiteImages;
  }

  public Map<String, String> getDeliverySiteImages() {
    return deliverySiteImages;
  }

  public void setDeliverySiteImages(Map<String, String> deliverySiteImages) {
    this.deliverySiteImages = deliverySiteImages;
  }
}
