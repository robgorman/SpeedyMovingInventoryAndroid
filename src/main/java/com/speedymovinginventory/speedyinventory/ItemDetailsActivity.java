...
public class ItemDetailsActivity extends LaunchCameraBaseActivity {
        ...
        if (item != null){
          if (checked) {
            if (!item.getIsScanned()) {
              ...
              // current location comes from the base class: todo change
...
*/
  ...
  public void onActivityResult(int requestCode, int resultCode, Intent data) {
    ...
    if (requestCode == QRC_CODE_REPLACEMENT && resultCode == RESULT_OK){
